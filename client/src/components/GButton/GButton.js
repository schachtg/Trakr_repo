...
export default function GButton({children, icon, givenWidth="auto", iconSize=0.8, disabled=false, warning=false, alternate=false, transparent=false, type=null, ...props}) {
